...
from root_tool import Profile1D_def
...
BRANCHES = [ # see details at Profile1D_def in the module interface/root_tool.py
    {"output": "muonpt_matchingEff", "name": "muon_pt", "ymean" : "muonMCMatched", "bins": 30, "xmin": 0.0, "xmax": 300.0, "xtitle": "muonPt [GeV]", "ytitle": "Multiplicity", "condition": None},
    {"output": "muoneta_matchingEff", "name": "muon_eta", "ymean" : "muonMCMatched", "bins": [-3, -2.4, -2.1, -1.8, -1.5, -1.2, -0.9, 0, 0.9, 1.2, 1.5, 1.8, 2.1, 2.4, 3], "xmin": -3.0, "xmax": 3.0, "xtitle": "muonEta", "ytitle": "Multiplicity", "condition": None},
    {"output": "muonphi_matchingEff", "name": "muon_phi", "ymean" : "muonMCMatched", "bins": 20, "xmin": -3.2, "xmax": 3.2, "xtitle": "muonPhi", "ytitle": "Multiplicity", "condition": None},
    {"output": "muoniso_matchingEff", "name": "muon_iso", "ymean" : "muonMCMatched", "bins": 30, "xmin": 0.0, "xmax": 0.15, "xtitle": "muonIso", "ytitle": "Multiplicity", "condition": None}
]
...
def draw_profile(root_rdf, tree_name, branch, output_dir="."):
    ...
    for name, style in CONDITIONS.items():
        ...
        profiles[name] = Profile1D_def(root_rdf, branch)
