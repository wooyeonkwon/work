...
TREE_NAMES = ["TnPTree"]    # set tree path of the root file, you can use multiple trees.
CONDITIONS = {
    "muon_isGlobal": {"condition": "", "color": ROOT.kBlue, "marker": 4},
}

BRANCHES = [ # see details at Profile1D_def in the module interface/root_tool.py
    {"output": "muonpt_matchingEff", "name": "probeMuon_pt", "ymean" : "muon_isRPCPassProbe", "bins": 30, "xmin": 0.0, "xmax": 300.0, "xtitle": "muonPt [GeV]", "ytitle": "Multiplicity", "condition": None},
    {"output": "muoneta_matchingEff", "name": "probeMuon_eta", "ymean" : "muon_isRPCPassProbe", "bins": [-3, -2.4, -2.1, -1.8, -1.5, -1.2, -0.9, 0, 0.9, 1.2, 1.5, 1.8, 2.1, 2.4, 3], "xmin": -3.0, "xmax": 3.0, "xtitle": "muonEta", "ytitle": "Multiplicity", "condition": None},
    {"output": "muonphi_matchingEff", "name": "probeMuon_phi", "ymean" : "muon_isRPCPassProbe", "bins": 20, "xmin": -3.2, "xmax": 3.2, "xtitle": "muonPhi", "ytitle": "Multiplicity", "condition": None},
    {"output": "muoniso_matchingEff", "name": "probeMuon_iso", "ymean" : "muon_isRPCPassProbe", "bins": 30, "xmin": 0.0, "xmax": 0.15, "xtitle": "muonIso", "ytitle": "Multiplicity", "condition": None}
]
